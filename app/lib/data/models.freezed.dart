...
mixin _$Profile {
 ...
 int get points; double get rating; String get userEmail;// Fecha de nacimiento (ISO 'yyyy-MM-dd'). Se pide en el registro para
// verificar la edad (age gate). Vacío en cuentas viejas o de Google.
 String get birthdate;// Insignia de clan (hasta 4 caracteres) y colores del avatar (hex de 6
...
// Presencia actual (se actualiza al empezar/terminar un partido).
 bool get playing; String get playingCourtId; String get playingSince;// ISO8601, '' si no está jugando
// Último partido jugado (para mostrar a los amigos cuando no está jugando).
 String get lastPlayedCourtId; String get lastPlayedAt;// ISO8601, '' si nunca jugó
 bool get showLastPlayed;// privacidad: mostrarlo a los amigos
 bool get isAdmin;
...
@useResult
$Res call({
 String pageId, String name, String handle, String phone, String city, double lat, double lng, String avatar, String position, double height, int games, int courts, int streak, int points, double rating, String userEmail, String birthdate, String clan, String avatarColor, String clanTextColor, String clanFont, String avatarFrame, String title, String level, List<String> unlockedBadges, int playSeconds, String playTimeByCourt, bool shareStatus, bool shareCourt, bool shareTime, bool playing, String playingCourtId, String playingSince, String lastPlayedCourtId, String lastPlayedAt, bool showLastPlayed, bool isAdmin
});
...
/// Create a copy of Profile
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? pageId = null,Object? name = null,Object? handle = null,Object? phone = null,Object? city = null,Object? lat = null,Object? lng = null,Object? avatar = null,Object? position = null,Object? height = null,Object? games = null,Object? courts = null,Object? streak = null,Object? points = null,Object? rating = null,Object? userEmail = null,Object? birthdate = null,Object? clan = null,Object? avatarColor = null,Object? clanTextColor = null,Object? clanFont = null,Object? avatarFrame = null,Object? title = null,Object? level = null,Object? unlockedBadges = null,Object? playSeconds = null,Object? playTimeByCourt = null,Object? shareStatus = null,Object? shareCourt = null,Object? shareTime = null,Object? playing = null,Object? playingCourtId = null,Object? playingSince = null,Object? lastPlayedCourtId = null,Object? lastPlayedAt = null,Object? showLastPlayed = null,Object? isAdmin = null,}) {
...
as String,lastPlayedCourtId: null == lastPlayedCourtId ? _self.lastPlayedCourtId : lastPlayedCourtId // ignore: cast_nullable_to_non_nullable
as String,lastPlayedAt: null == lastPlayedAt ? _self.lastPlayedAt : lastPlayedAt // ignore: cast_nullable_to_non_nullable
as String,showLastPlayed: null == showLastPlayed ? _self.showLastPlayed : showLastPlayed // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String pageId,  String name,  String handle,  String phone,  String city,  double lat,  double lng,  String avatar,  String position,  double height,  int games,  int courts,  int streak,  int points,  double rating,  String userEmail,  String birthdate,  String clan,  String avatarColor,  String clanTextColor,  String clanFont,  String avatarFrame,  String title,  String level,  List<String> unlockedBadges,  int playSeconds,  String playTimeByCourt,  bool shareStatus,  bool shareCourt,  bool shareTime,  bool playing,  String playingCourtId,  String playingSince,  String lastPlayedCourtId,  String lastPlayedAt,  bool showLastPlayed,  bool isAdmin)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Profile() when $default != null:
return $default(_that.pageId,_that.name,_that.handle,_that.phone,_that.city,_that.lat,_that.lng,_that.avatar,_that.position,_that.height,_that.games,_that.courts,_that.streak,_that.points,_that.rating,_that.userEmail,_that.birthdate,_that.clan,_that.avatarColor,_that.clanTextColor,_that.clanFont,_that.avatarFrame,_that.title,_that.level,_that.unlockedBadges,_that.playSeconds,_that.playTimeByCourt,_that.shareStatus,_that.shareCourt,_that.shareTime,_that.playing,_that.playingCourtId,_that.playingSince,_that.lastPlayedCourtId,_that.lastPlayedAt,_that.showLastPlayed,_that.isAdmin);case _:
  return orElse();
...
class _Profile extends Profile {
  const _Profile({this.pageId = '', this.name = '', this.handle = '', this.phone = '', this.city = '', this.lat = 0.0, this.lng = 0.0, this.avatar = '', this.position = '', this.height = 0.0, this.games = 0, this.courts = 0, this.streak = 0, this.points = 0, this.rating = 0.0, this.userEmail = '', this.birthdate = '', this.clan = '', this.avatarColor = '', this.clanTextColor = '', this.clanFont = '', this.avatarFrame = '', this.title = '', this.level = '', final  List<String> unlockedBadges = const <String>[], this.playSeconds = 0, this.playTimeByCourt = '', this.shareStatus = false, this.shareCourt = false, this.shareTime = false, this.playing = false, this.playingCourtId = '', this.playingSince = '', this.lastPlayedCourtId = '', this.lastPlayedAt = '', this.showLastPlayed = false, this.isAdmin = false}): _unlockedBadges = unlockedBadges,super._();
...
// ISO8601, '' si no está jugando
// Último partido jugado (para mostrar a los amigos cuando no está jugando).
@override@JsonKey() final  String lastPlayedCourtId;
@override@JsonKey() final  String lastPlayedAt;
// ISO8601, '' si nunca jugó
@override@JsonKey() final  bool showLastPlayed;
// privacidad: mostrarlo a los amigos
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,pageId,name,handle,phone,city,lat,lng,avatar,position,height,games,courts,streak,points,rating,userEmail,birthdate,clan,avatarColor,clanTextColor,clanFont,avatarFrame,title,level,const DeepCollectionEquality().hash(_unlockedBadges),playSeconds,playTimeByCourt,shareStatus,shareCourt,shareTime,playing,playingCourtId,playingSince,lastPlayedCourtId,lastPlayedAt,showLastPlayed,isAdmin]);
...
/// Create a copy of Profile
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? pageId = null,Object? name = null,Object? handle = null,Object? phone = null,Object? city = null,Object? lat = null,Object? lng = null,Object? avatar = null,Object? position = null,Object? height = null,Object? games = null,Object? courts = null,Object? streak = null,Object? points = null,Object? rating = null,Object? userEmail = null,Object? birthdate = null,Object? clan = null,Object? avatarColor = null,Object? clanTextColor = null,Object? clanFont = null,Object? avatarFrame = null,Object? title = null,Object? level = null,Object? unlockedBadges = null,Object? playSeconds = null,Object? playTimeByCourt = null,Object? shareStatus = null,Object? shareCourt = null,Object? shareTime = null,Object? playing = null,Object? playingCourtId = null,Object? playingSince = null,Object? lastPlayedCourtId = null,Object? lastPlayedAt = null,Object? showLastPlayed = null,Object? isAdmin = null,}) {
